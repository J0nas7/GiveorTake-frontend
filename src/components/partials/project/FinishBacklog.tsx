...
export const FinishBacklog = () => {
    ...
    useEffect(() => {
        ...
        if (backlogId) document.title = `Finishing Backlog: ${backlogById?.Backlog_Name} - GiveOrTake`
    }, [backlogById])
    ...
    return (
        <Block className="page-content">
            <Link
                href={`/project/${backlogById?.Project_ID}`}
                className="blue-link"
            >
                &laquo; Go to Project
            </Link>
            ...
            <FlexibleBox
                title={`Finishing Backlog: ${backlogById?.Backlog_Name}`}
                icon={faCheckCircle}
                ...
                <Card>
                    <CardContent>
                        ...
                        <Block className="my-3">
                            <Text>You can finish this backlog, and move all unfinished tasks to the primary project-backlog, or move them to a new backlog.</Text>
