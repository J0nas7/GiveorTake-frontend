import { LoadingStateType, Project, Status, Task, Team } from "./"
...
export type BacklogStates = Backlog | LoadingStateType
export type BacklogsStates = Backlog[] | LoadingStateType
